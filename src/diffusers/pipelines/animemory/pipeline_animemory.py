...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ...     "animEEmpire/animemory", torch_dtype=torch.float16
        ... )
        >>> pipe = pipe.to("cuda")

        >>> prompt = 'A cute cat.'
        >>> negative_prompt = 'nsfw, worst quality, low quality, normal quality, low resolution, blurry, wrong, Mutated hands and fingers, text, ugly faces, twisted, jpeg artifacts, watermark, low contrast'
        >>> image = pipe(
        ...     prompt=prompt,
